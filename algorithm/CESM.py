...
from ESPM_Col import BIESP_Col_baseline
import cProfile, pstats


def copes_miner(count_dict, original_distances_dict, changed_distances_dict, r, min_prev, min_ei, min_overlap, original_files):
    #获取所有显著二元变化同位模式
    i = 0
    ESPs = {}
...
# # 把运行结果保存到临时文件
# cProfile.run(
#     'copes_miner(count_dict, original_distances_dict, changed_distances_dict, r, min_prev, min_ei, min_overlap)',
